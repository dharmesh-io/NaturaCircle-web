    ...
    return (
      <div className="container py-12">
        ...
        <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-8 text-center">
          ...
          <p className="mt-2 text-muted-foreground">Add products to your cart before checking out.</p>
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="rounded-lg border bg-card p-6">
              ...
              <h3 className="mt-6 text-lg font-semibold mb-4">Delivery Address</h3>
            ...
            <div className="rounded-lg border bg-card p-6">
                ...
                <div className="mt-6 space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData((prev) => ({ ...prev, cardNumber: e.target.value.replace(/\s/g, "").substring(0, 16) }))}
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData((prev) => ({ ...prev, expiryDate: e.target.value.substring(0, 5) }))}
                        placeholder="MM/YY"
                        required
                        className="w-full rounded-md border bg-background px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="cvv"
                        value={formData.cvv}
                        onChange={(e) => setFormData((prev) => ({ ...prev, cvv: e.target.value.substring(0, 3) }))}
                        placeholder="123"
                        required
                        className="w-full rounded-md border bg-background px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary"
                      />
              ...
              {paymentMethod === "upi" && (
                <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <p className="text-sm text-blue-800">You will be redirected to your UPI app to complete the payment securely.</p>
                </div>
              )}

              {paymentMethod === "netbanking" && (
                <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <p className="text-sm text-blue-800">You will be redirected to your bank's secure payment gateway.</p>
                </div>
              )}
            </div>
